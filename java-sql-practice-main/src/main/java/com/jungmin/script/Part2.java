...
public class Part2 {
  ...
  */
  public static final String PART2_3 = "INSERT INTO Users(username, email, password) VALUES ('Joker', 'gotham@bat.man', 4444)";
  ...
  */
  public static final String PART2_8 = "SELECT p.title, u.username FROM Posts as p JOIN Users as u ON u.user_id = p.user_id";
  ...
  */
  public static final String PART2_10 ="INSERT INTO Posts(user_id, title, content) VALUES (1, 'unhappy', 'I want to go home now')";

  /*
  ----------------------------------------------------------------------------------------------
      TODO: Q 2-11. 어느 board에도 속하지 않는 post의 모든 데이터를 찾기위한 SQL을 작성해주세요.")
  */
  public static final String PART2_11 = "SELECT * FROM Posts as p LEFT JOIN Boards as b ON b.board_id = p.board_id WHERE p.board_id IS NULL";

  /*
  ----------------------------------------------------------------------------------------------
      TODO: Q 2-12. users 테이블의 user_id가 1인 유저가 작성한 post의 title을 찾기위한 SQL을 작성해주세요.
  */
  public static final String PART2_12 = "SELECT title FROM Posts as p JOIN Users as u ON u.user_id = p.user_id WHERE u.user_id = 1";

  /*
  ----------------------------------------------------------------------------------------------
      TODO: Q 2-13. users 테이블의 user_id가 1인 유저가 작성한 post의 board name을 찾기위한 SQL을 작성해주세요.
  */
  public static final String PART2_13 = "SELECT name FROM Boards as b JOIN Posts as p ON p.board_id = b.board_id WHERE p.user_id = 1";
  ...
  */
  public static final String PART2_15 = "SELECT COUNT(comment_id) as CommentCount FROM Comments as c " +
          "JOIN Users as u ON u.user_id = c.user_id WHERE u.username = 'luckykim'";
  ...
  */
  public static final String PART2_16 = "SELECT u.username, COUNT(comment_id) as CommentCount " +
          "FROM Users as u LEFT JOIN Comments as c ON u.user_id = c.user_id GROUP BY u.username";

  /*
  ----------------------------------------------------------------------------------------------
      TODO: Q 2-17. 각 board의 name과 해당 board에 속한 post의 개수 (컬럼명: PostCount)를 출력하기 위한 SQL을 작성해주세요.
  */
  public static final String PART2_17 = "SELECT b.name, COUNT(post_id) as PostCount FROM Boards as b " +
  ...
  */
  public static final String PART2_18 = "SELECT b.name, AVG(CHAR_LENGTH(p.content)) as AvgLength FROM Boards as b " +
          "LEFT JOIN Posts as p ON b.board_id = p.board_id GROUP BY b.name";
  // sql에서 length는 바이트 크기, char_length는 길이를 가져옴. 그래서 안됐음.
  ...
  */
  public static final String PART2_19 = "SELECT b.name, AVG(CHAR_LENGTH(p.content)) as AvgLength FROM Boards as b " +
          "JOIN Posts as p ON b.board_id = p.board_id GROUP BY b.name";
  ...
  */
  public static final String PART2_20 = "SELECT t.name, COUNT(pt.post_id) as PostCount FROM Tags as t " +
          "LEFT JOIN Post_Tags as pt ON pt.tag_id = t.tag_id GROUP BY t.name ORDER BY t.name";
}
